...
export const queryKeys = {
  ...
  personalVerseNotes: (userId: string, scope: string) =>
    ['personalVerseNotes', userId, scope] as const,
  ...
  canMessageUser: (userId: string, targetUserId: string) =>
    ['canMessageUser', userId, targetUserId] as const,
